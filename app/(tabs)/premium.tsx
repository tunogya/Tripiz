import {
  View, Text, ScrollView, Dimensions, Pressable, TouchableOpacity,
} from "react-native";
          ...
          <View className={"bg-[#242424] rounded-lg overflow-hidden relative"}>
            ...
            <View className={"px-4 py-2 space-y-1"}>
              <View className={"flex flex-row items-center space-x-2"}>
                ...
                <Text className={"text-white"}>1 个Premium标准账户</Text>
              </View>
              <View className={"flex flex-row items-center space-x-2"}>
                <View className={"w-1.5 h-1.5 bg-white rounded-full mx-1"}></View>
            ...
            <View className={"p-4"}>
              <Text className={"text-xs text-[#A7A7A7] text-center"}>免费试用 1 个月，之后每月 38 人民币。方案将每月自动续期，直到你取消为止。</Text>
            </View>
          </View>
        </View>
        <View className={"px-4"}>
          <View className={"bg-[#242424] rounded-lg overflow-hidden relative"}>
            ...
            <View className={"px-4 py-2"}>
              <Text className={"text-[#A9BACF] text-2xl font-bold"}>Family</Text>
            </View>
            <View className={"px-4 py-2 space-y-1"}>
              <View className={"flex flex-row items-center space-x-2"}>
                <View className={"w-1.5 h-1.5 bg-white rounded-full mx-1"}></View>
                <Text className={"text-white"}>最多 6 个Premium标准账户</Text>
              </View>
              <View className={"flex flex-row items-center space-x-2"}>
                <View className={"w-1.5 h-1.5 bg-white rounded-full mx-1"}></View>
                <Text className={"text-white"}>你可以随时取消订阅</Text>
            ...
            <View className={"p-4"}>
              <Text className={"text-xs text-[#A7A7A7] text-center"}>每月 58 人民币。方案将每月自动续期，直到你取消为止。</Text>
            </View>
          </View>
        </View>
        <TouchableOpacity className={"p-4"} hitSlop={4}>
